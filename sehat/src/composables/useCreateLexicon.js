  ...
  const make_newLexicon = (under_operation) => {
    ...
    let sp_comments=med_panel[4];
     ...
     if(category=="Symptoms"){
      ...
      lexicon_load.value=symptom.loading;
     }
     if(category=="Diagnosis"){
      ...
      lexicon_load.value=diagnosis.loading;
     }
     if(category=="labs"){
      ...
      lexicon_load.value=labs.loading;
     }
     if(category=="Meds"){
      ...
      lexicon_load.value=meds.loading;
     }
     if(category=="surg"){
      ...
      lexicon_load.value=surg.loading;
     }
     if(category=="Allergy"){
      ...
      lexicon_load.value=allergy.loading;
     }
  };

return { make_newLexicon, error_lexicon,lexicon_flag,lexicon_load,lexicon_id,history_flag }
}
