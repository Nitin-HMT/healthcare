...
export function suggest() {
    ...
    function normalizeinput(raw){
            ...
            for(let i = 0; i<step_2.length; i++){
                search_result.value.push({pos:[i],Display:step_2[i],Functional:step_2[i],Category:"Unknown",Item:"",
                    Qualifier:[],Symbol:"",Original:step_2[i]})
            }
    ...
    const all_keys=[...sym_key, ...med_key, ...lab_key, ...diag_key, ...surg_key, ...allergy_key]
