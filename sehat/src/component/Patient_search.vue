<template>
  <div>
     ...
     <div class="bg-blue-50 bg-opacity-30 border-solid border-b-2 border-green-100">
      <div class=" px-[30px] py-2 mx-6 grid grid-cols-12 gap-2">
        <div></div>
        <div class="col-span-9">
          <Autocomplete 
            ...
            :multiple="false"
            class="block w-full rounded-full px-2 py-3 font-serif bg-gray-100 border-solid border border-gray-100 hover:bg-gray-200/90 transition-all "
          >
          <template #item-prefix="{ option }">
            ...
            <!--<FeatherIcon
              ...
              name="search"
            />-->
            <FeatherIcon class="w-6 h-6 mr-4 text-gray-700"  name="users"/>
            </template>
          </Autocomplete>
        </div>
