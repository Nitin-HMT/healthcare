...
<div class="flex flex-row items-center justify-center" v-if="vitals_flag">
  <Button @click="vital_dialog=true" class="drop-shadow-sm hover:bg-gradient-to-br from-white via-white to-purple-200 bg-white hover:bg-white -mt-0.5 mr-1 py-1 px-5 rounded-b-full">
    <span class="hover:text-gray-900 leading-none">Vitals History</span>
  </Button>
  <Button @click="vitalsqueue(app.get(props.App_id))" class="drop-shadow-sm hover:bg-gradient-to-br from-white via-white to-purple-200 bg-white hover:bg-white -mt-0.5 py-1 px-7 rounded-b-full">
...
<Dialog v-model="vital_dialog" :options="{size: '4xl'}">
    ...
    <template #body-content>
      <div class="flex flex-col gap-3">
        <VitalsHistory :Pat_id="props.Pat_id" :App_id= "props.App_id" :Request_from= "props.Request_from"/>
      </div>
    </template>
    <template #actions>
