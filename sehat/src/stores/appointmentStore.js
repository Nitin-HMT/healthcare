      ...
      for (let d of data) {
        if (
          ...
          if (!d.vital_sign) {
            ...
            let pt = {
              label: label,
              vital_record: d.vital_sign,
              doctor: d.practitioner,
              age: d.patient_age,
              value: value,
              gender: d.patient_sex,
              gen_abbr: d.patient_sex,
              name: d.name,
              Vitals: vitals,
            };
          ...
          const existingLabGroup = appointments.value.find(
