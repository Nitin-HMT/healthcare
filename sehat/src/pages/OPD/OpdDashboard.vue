<template>
  ...
  <div class="m-1 md:grid md:grid-cols-2" >
      ...
      <div class="m-2 p-2 bg-white drop-shadow-xl rounded-md transition-all duration-300 ease-in-out">
        <div class="">
          Current Appointments
        </div> 
        <AppointQueue v-if="!appoint_flag" class="transition-opacity duration-3000 ease-in-out"/>
        <NewAppointment v-else class="transition-opacity duration-3000 ease-in-out"/>
      </div>
      <div class="m-2 p-2 bg-white drop-shadow-xl rounded-md shadow-red-500 transition-all duration-300 ease-in-out">
          <OpdTasks/>
      </div>
